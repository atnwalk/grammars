...
ctx.rule(u'FUNCTION', u'{FUNCDEF} ({FUNCTIONARGS}) {PROGRAM}\nend')
ctx.rule(u'FUNCDEF', u'function {VAR}.{IDENTIFIER}')
ctx.rule(u'FUNCDEF', u'function {VAR}:{IDENTIFIER}')
ctx.rule(u'FUNCDEF', u'function {IDENTIFIER}')
ctx.rule(u'LAMBDA', u'function ({FUNCTIONARGS}) {PROGRAM}\nend')
ctx.rule(u'FUNCTIONARGS', u'{AUX_2}')
ctx.rule(u'AUX_2', u'')
ctx.rule(u'AUX_2', u'{FUNCTIONARGLIST}')
ctx.rule(u'FUNCTIONARGLIST', u'{VAR}, {FUNCTIONARGLIST}')
ctx.rule(u'FUNCTIONARGLIST', u'{VAR}')
ctx.rule(u'FUNCTIONARGLIST', u'...')
...
ctx.rule(u'EXPR', u'{IDENTIFIER} {ARGS}')
ctx.rule(u'EXPR', u'{EXPR}:{IDENTIFIER} {ARGS}')
ctx.rule(u'EXPR', u'{EXPR}.{IDENTIFIER} {ARGS}')
...
ctx.rule(u'LITERALSTRING', u'[[{STRING}]]')
ctx.rule(u'STRING', u'{AUX_3}')
ctx.rule(u'AUX_3', u'')
ctx.rule(u'AUX_3', u'{STRCHR}{AUX_3}')
ctx.rule(u'STRCHR', u'{NEWLINE}')
...
ctx.rule(u'ESCAPESEQUENCE', u'{NEWLINE}')
...
ctx.rule(u'DECIMAL', u'{AUX_4}{AUX_5}')
ctx.rule(u'AUX_4', u'{DECIMALDIGIT}')
ctx.rule(u'AUX_4', u'{DECIMALDIGIT}{AUX_4}')
ctx.rule(u'AUX_5', u'')
ctx.rule(u'AUX_5', u'{GROUP_1}')
ctx.rule(u'GROUP_1', u'{AUX_6}{GROUP_3}{AUX_7}')
ctx.rule(u'AUX_6', u'')
ctx.rule(u'AUX_6', u'{GROUP_2}')
ctx.rule(u'AUX_7', u'{DECIMALDIGIT}')
ctx.rule(u'AUX_7', u'{DECIMALDIGIT}{AUX_7}')
ctx.rule(u'GROUP_2', u'.{AUX_8}')
ctx.rule(u'AUX_8', u'{DECIMALDIGIT}')
ctx.rule(u'AUX_8', u'{DECIMALDIGIT}{AUX_8}')
ctx.rule(u'GROUP_3', u'e')
ctx.rule(u'GROUP_3', u'e-')
ctx.rule(u'HEXADECIMAL', u'{AUX_9}{AUX_10}')
ctx.rule(u'AUX_9', u'{HEXDIGIT}')
ctx.rule(u'AUX_9', u'{HEXDIGIT}{AUX_9}')
ctx.rule(u'AUX_10', u'')
ctx.rule(u'AUX_10', u'{GROUP_4}')
ctx.rule(u'GROUP_4', u'{AUX_11}{GROUP_6}{AUX_12}')
ctx.rule(u'AUX_11', u'')
ctx.rule(u'AUX_11', u'{GROUP_5}')
ctx.rule(u'AUX_12', u'{HEXDIGIT}')
ctx.rule(u'AUX_12', u'{HEXDIGIT}{AUX_12}')
ctx.rule(u'GROUP_5', u'.{AUX_13}')
ctx.rule(u'AUX_13', u'{HEXDIGIT}')
ctx.rule(u'AUX_13', u'{HEXDIGIT}{AUX_13}')
ctx.rule(u'GROUP_6', u'p')
ctx.rule(u'GROUP_6', u'p-')
