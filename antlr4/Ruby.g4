...
statement: DEF VAR DOT IDENTIFIER OPENPAR args? CLOSEPAR NEWLINE program END
    | VAR EQ VAR DOT IDENTIFIER OPENPAR args? CPOBP args? PIPE program CLOSEBRACES
    | VAR EQ IDENTIFIER DOT IDENTIFIER OPENPAR args? CPOBP args? PIPE program CLOSEBRACES
    | VAR EQ val
    | RETURN VAR
    | RAISE VAR
    | YIELD VAR
